...
BaseTouchObject::BaseTouchObject() :
	mPosition( ci::vec2(0) ),
	mParentTranslatePosition(ci::vec2(0)),
	mWidth(0.0f),
	mHeight(0.0f),
...
void BaseTouchObject::setup(const ci::vec2 &pos, const ci::vec2 &size){
...
bool BaseTouchObject::hasTouchPoint( const ci::vec2 &pnt ){
